...
public class TraineeController {
	...
	@PostMapping("/traineeTrainings")
	public ResponseEntity<List<TraineeTrainingResponseDto>> getTraineeTrainingsList(@RequestBody @Valid TraineeTrainingDto traineeTraining) throws UserException{
		log.info("Received GET request to retrieve a Trainee Trainings List");
		return new ResponseEntity<>(traineeService.getTraineeTrainingsList(traineeTraining),HttpStatus.OK);
	}
