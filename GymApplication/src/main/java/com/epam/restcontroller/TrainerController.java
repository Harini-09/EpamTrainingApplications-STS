...
public class TrainerController {
	...
	@PostMapping("/trainerTrainings")
	public ResponseEntity<List<TrainerTrainingResponseDto>> getTrainerTrainingsList(@RequestBody @Valid TrainerTrainingDto trainerTraining) throws UserException{
		log.info("Received GET request to retrieve a Trainer Trainings List");
		return new ResponseEntity<>(trainerService.getTrainerTrainingsList(trainerTraining),HttpStatus.OK);
	}
}
