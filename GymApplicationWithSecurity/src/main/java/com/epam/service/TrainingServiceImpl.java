...
public class TrainingServiceImpl implements TrainingService{
	...
	public void saveTraining(TrainingDetailsDto trainingDetails) throws UserException, TrainingTypeException, TrainerException {
	 ...
	 userTrainee.getTrainee().getTrainersList()
		...
		Message<NotificationDto> notificationMessage = MessageBuilder.withPayload(notificationDto)
				 										 			 .setHeader(KafkaHeaders.TOPIC, "notificationtopic")
				 										 			 .build();
		notificationKafkaTemplate.send(notificationMessage);
		
		Message<TrainingReportDto> reportMessage = MessageBuilder.withPayload(trainingReportDto)
				 										 	   	 .setHeader(KafkaHeaders.TOPIC, "report-topic")
				 										 	     .build();
