...
//	private KafkaTemplate<String,NotificationDto> kafkaTemplate;
	...
	@Override
	@Transactional  //Adding @Transactional at the method level ensures that the entire method executes within a single transaction. If an exception occurs, the transaction will be rolled back, ensuring consistency. If the method completes successfully, the transaction will be committed.
